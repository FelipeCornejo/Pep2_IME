...
# Se sacan las variables Weight, Height y Gender para que no aparezcan en la muestra. las primeras dos son dependientes de IMC y la tercera no aporta ninguna información.
...
error <- as.numeric(prueba[["EN"]]) - predicciones
